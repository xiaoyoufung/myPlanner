    ...
    <div class="btm-sec">
        ...
        <div class="btm-right-sec">
            ...
            <div class="add-container">
                <div class="add-top">
                    <div class="add-btn">
                        <a href="wallet.php"><button class="income-btn-hover">Income</button></a>
                        <a href="wallet2.php"><button class="expense-btn-hover">Expense</button></a>
                    </div>
                    <a href="expense.php"><img class="add-icon" src="img/dropdown-grey-icon.svg" alt="dropdown-grey-icon" width="24px"></a>
                </div>
                <div class="add-form-container">
                    <div><?php include('add-expense.php') ?><div>
                </div>
            </div>
        </div>
    </div>
